...
export const en: Translation = {
  ...
  telegram: {
    ...
    linkInstructions: "To connect your Telegram account, follow these steps:",
    openBot: "1. Open our Telegram bot",
    sendCommand: "2. Send the following command to the bot:",
    afterLink: "After linking your account, you'll be able to receive notifications about important events directly in Telegram.",
    receiveNotifications: "Receive notifications via Telegram",
    sendTestNotification: "Send Test Notification",
    testNotificationSent: "Test notification sent!",
    disconnect: "Disconnect",
    disconnected: "Telegram account disconnected successfully",
    confirmDisconnect: "Disconnect Telegram?",
    disconnectWarning: "You won't receive notifications in Telegram anymore. You can reconnect at any time.",
  },
...
export const ru: Translation = {
  ...
  telegram: {
    ...
    linkInstructions: "Для подключения вашего аккаунта Telegram выполните следующие шаги:",
    openBot: "1. Откройте нашего Telegram бота",
    sendCommand: "2. Отправьте боту следующую команду:",
    afterLink: "После привязки аккаунта вы сможете получать уведомления о важных событиях прямо в Telegram.",
    receiveNotifications: "Получать уведомления через Telegram",
    sendTestNotification: "Отправить тестовое уведомление",
    testNotificationSent: "Тестовое уведомление отправлено!",
    disconnect: "Отключить",
    disconnected: "Аккаунт Telegram успешно отключен",
    confirmDisconnect: "Отключить Telegram?",
    disconnectWarning: "Вы больше не будете получать уведомления в Telegram. Вы можете переподключить аккаунт в любое время.",
  },
  ...
  messages: {
    ...
    invalidLink: "Недействительная ссылка для входа",
    linkExpired: "Срок действия ссылки для входа истек",
