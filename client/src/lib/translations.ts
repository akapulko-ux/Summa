...
export const en: Translation = {
  ...
  auth: {
    ...
    agreeToTerms: "By clicking the button, you accept the terms of the license agreement and consent to the processing of personal data",
  ...
  services: {
    ...
    clientServicesTitle: "Add your services or choose new",
...
export const ru: Translation = {
  ...
  auth: {
    ...
    agreeToTerms: "Нажимая кнопку, вы принимаете условия лицензионного соглашения и даёте согласие на обработку персональных данных",
  ...
  services: {
    ...
    clientServicesTitle: "Добавьте ваши сервисы или выберите новый",
