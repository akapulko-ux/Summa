...
export const en: Translation = {
  ...
  subscriptions: {
    ...
    addDescription: "Fill out the form to add a new subscription",
    editSubscription: "Edit Subscription",
    subscriptionTitle: "Subscription Title",
    service: "Service",
    serviceName: "Service Name",
    enterServiceName: "Enter service name",
    customServiceNameDescription: "Enter the name for your custom service",
    predefinedServiceNameDescription: "This field is filled automatically for predefined services",
