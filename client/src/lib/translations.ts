...
export const en: Translation = {
  ...
  auth: {
    ...
    agreeToTerms: "By clicking the button, you accept the terms of the",
    licenseAgreement: "license agreement",
    andConsentTo: "and consent to the processing of",
...
export const ru: Translation = {
  ...
  auth: {
    ...
    agreeToTerms: "Нажимая кнопку, вы принимаете условия",
    licenseAgreement: "лицензионного соглашения",
    andConsentTo: "и даёте согласие на обработку",
